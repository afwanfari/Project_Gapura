<div>
    ...
    <div class="block py-24 px-10 bg-gray-500 text-white text-center items-center space-x-4">
        <h1 class="text-2xl font-bold leading-none">Welcome to Harapan Bangsa Trainer Center Indonesia</h1>
    ...
    <div class="relative px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28 2/3">
        ...
        <div class="relative mx-auto max-w-7xl">
            <div class="text-center">
                <h2 class="text-xl font-bold tracking-tight text-gray-900 ">Kami Juga Memproduksi Trainer Dengan
                    Spesifikasi Produk Import.</h2>
                <p class="mx-auto mt-3 max-w-2xl text-xl text-gray-500 sm:mt-4">This is your life and it's ending one
                    minute @ a time...</p>
            </div>
