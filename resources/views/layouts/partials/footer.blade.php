<footer class="bg-gray-800 text-white py-2 flex-grow">
    <div class=" flex flex-wrap justify-center items-center px-4 mx-auto overflow-hidden lg:flex-row">
        <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0 justify-between">
            <ul class="flex flex-col w-full p-0 font-medium text-center list-none">
                <h3 class=" font-bold text-lg mb-4">CV GAPURA</h3>
                <p>Jl. Raden Intan, Terminal Arjosari Blok A/34<br> Arjosari,Blimbing, Kota
                    Malang, Jawa Timur, Indonesia 65126<br>Jawa Timur - Indonesia</p>
                <p>📞 (+62) 851 101 195 575 (Yusron)</p>
            </ul>
            <div class=" flex flex-col w-full">
                <h3 class=" font-bold text-lg text-center mb-4">Follow Us</h3>
                <div class="flex justify-center pl-4 mt-2">
                    <a class="flex items-center  mr-6 text-gray-400 no-underline hover:text-gray-600" target="_blank"
    ...
    <div class="pt-4 mt-10 w-full text-center border-t">© CV.GAPURA 2024. All rights
        reserved.</div>
</footer>
