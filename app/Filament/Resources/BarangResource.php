...
class BarangResource extends Resource
{
    ...
    {
        return $table
            ->columns([Tables\Columns\TextColumn::make('idbarang'), Tables\Columns\TextColumn::make('nama'), Tables\Columns\TextColumn::make('jenis_barang'), Tables\Columns\TextColumn::make('gambar'), Tables\Columns\TextColumn::make('deskripsi'), Tables\Columns\TextColumn::make('komponen_terpasang'), Tables\Columns\TextColumn::make('dimensi'), Tables\Columns\TextColumn::make('bahan'), Tables\Columns\TextColumn::make('warna'), Tables\Columns\TextColumn::make('sumber_daya'), Tables\Columns\TextColumn::make('data_teknis'), Tables\Columns\TextColumn::make('aksesoris'), Tables\Columns\TextColumn::make('harga')])
